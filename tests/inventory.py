...
# Adding items
player_inventory.add_item("katana", {"damage": 12, "speed": 8}, "weapons", "melee", "blades")
player_inventory.add_item("longbow", {"damage": 15, "range": 20}, "weapons", "ranged")
player_inventory.add_item("broadsword", {"damage": 20, "speed": 4}, "weapons", "melee", "blades")
player_inventory.add_item("bow", {"damage": 10, "range": 15}, "weapons", "ranged")
player_inventory.add_item("spear", {"damage": 8, "speed": 6}, "weapons", "melee", "blades") 
...
player_inventory.add_item("bat", {"damage": 10, "speed": 7}, "weapons", "melee", "other")
player_inventory.add_item("mace", {"damage": 15, "speed": 4}, "weapons", "melee", "other")
